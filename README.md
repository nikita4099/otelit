...
- Почему станет лучше, чем сейчас, от использования `Product Owner`,  `Data Scientist`:  система сможет прогнозировать сделку лучше, чем это делает человек: анализировать сотни свободных помещений, вместо топ 10.  
- Что будем считать успехом итерации с точки зрения бизнеса `Product Owner`: рост конверсии до 7% (Сейчас 2-3).  

#### 1.2. Бизнес-требования и ограничения  

- Краткое описание БТ и ссылки на детальные документы с бизнес-требованиями `Product Owner`: {ссылка на бизнес-требования} 
